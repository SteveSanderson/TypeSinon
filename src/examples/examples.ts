...
var mockFeedAnimals = TypeSinon.spy((name: string) => { /* no code, so return type is void */ }),
    mockGetAnimals = TypeSinon.spy((category: Zoo.AnimalCategory): Zoo.Animal[]=> {
...
var mockBeginSelfDestruct = TypeSinon.spy<(string) => void>();
